 ...
 */
 @RunWith(classOf[JUnitRunner])
  ...
  test("sum of a list with negative numbers") {
    assert(sum(List(2,3,-1)) === 4)
  }

  test("sum of a list with only negative numbers") {
  ...
  test("max of a list with negative numbers") {
    assert(max(List(2,3,-1)) === 3)
  }

  test("max of a list with only negative numbers") {
  ...
  test("max of list, bigger element is the last one in list") {
    assert(max(List(1,2,3)) === 3)
  }

  test("max of list, bigger element is the first one in list") {
